    ...
    <div v-if="PopularExist">
      ...
      <v-row>
        <v-col xs="12" sm="6" md="3" lg="2" v-for="i in 6" :key="PopularPlaylists[i].id">
          <SongCard :id="PopularPlaylists[i].id" :name="PopularPlaylists[i].name"
                :description="PopularPlaylists[i].description" :images="PopularPlaylists[i].images"
                :type="PopularPlaylists[i].type"></SongCard>
        </v-col>
      </v-row>
    </div>
    <br><br>
